...
export default function Tstudent() {
  ...
  //   const [trainerView, setTrainerView] = useState([]);
  ...
  const [adminViewTrainerStudents, setAdminViewTrainerStudents] = useState([]);
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data && res.data.status === 1) {
          ...
          setAdminViewTrainerStudents((prev) =>
  ...
  const handleStudentGrade = async (student) => {
    ...
    await axios
      .post("https://www.globalschoolofyoga.com/grade/api/admin/adminViewStudGrade.php", idtosend)
      .then((res) => {
        console.log(res.data);
        navigate("/admin/admin-trainer-student-grade", {
  ...
  const handleGet = (student) => {
    ...
    axios
      .post("https://www.globalschoolofyoga.com/grade/api/admin/adminEdit&deleteStud.php", dataToSend)
      .then((res) => {
        if (res.data && res.data.status === 1) {
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      formDataToSend.append("trainer_Id", trainer_Id);
      ...
      const url = isEdit
        ? "https://www.globalschoolofyoga.com/grade/api/admin/adminEdit&deleteStud.php"
        : "https://www.globalschoolofyoga.com/grade/api/admin/adminViewTrainerStud.php";
  ...
  const getAllStudents = () => {
    if (trainer_Id) {
      const metaTrainer = new FormData()
      metaTrainer.append("action","fetchStudent")
      metaTrainer.append("trainer_Id",trainer_Id)
      axios
        .post(
          "https://www.globalschoolofyoga.com/grade/api/admin/adminViewTrainerStud.php",
          metaTrainer
        ...
        .then((response) => {
          if (response.data && response.data.status === 1) {
            setAdminViewTrainerStudents(response.data.viewStudent || []);
          } else {
            console.log("No trainer student found");
          }
        })
        .catch((error) => {
